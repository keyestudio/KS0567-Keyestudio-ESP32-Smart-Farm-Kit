### 5.6 Slim Voedersysteem



#### 5.6.1 Deur van de voederbak
...
Kies het **ESP32 Dev Module** board en de **COM** poort, en upload de
code.
...
De deur van de voederbak wordt langzaam geopend en vervolgens gesloten.

**OPMERKING:** SG90 servo kan 180° draaien. Omdat de voederbak klein is, is 100° rotatie voldoende om de bak volledig te sluiten.
...
③ Ingebouwde printplaat (Interne controller): de kern van de Servo. Het verwerkt externe controlesignalen en de feedbacksignalen van de positie en stuurt de Servo aan.
...
A. Als we een signaal met een pulsbreedte van 1,5 ms naar de Servo sturen, zal de as (hoorn) naar de middenpositie (90°) draaien;
...
#### 5.6.3 Intelligent Voedersysteem
...
Het slimme voedersysteem voedt huisdieren intelligent via een ultrasone module en een servo. De eerste detecteert de afstand tot dieren, terwijl de laatste de voederbak opent of sluit