...
beschermfolie eraf te halen om de wrijving te verminderen wanneer deze als
deur beweegt.
...
**Opmerking: De schroeven moeten worden vastgedraaid om de servo stabiel te
houden, anders kan de deur vastlopen.**
...
Draai het tandwiel niet nadat het op de servo is geïnstalleerd. Als u het
tandwiel al hebt gedraaid, moet u de servohoek opnieuw instellen op 180°.
...
1.  Sluit de Servo aan op pin IO26 van het ESP32-bord. Sluit geel aan op S,
    rood op V, zwart op G.

![image028-1](../media/image028-1-1744850789118-1.png)

2.  Sluit 6 AA-batterijen aan op de DC 7-12V-poort van het ESP32-bord.
...
A. Sluit het ESP32-bord aan op de computer met de USB-kabel. Open het
...
B. Klik op Extra, selecteer "ESP32 Dev Module" voor het bordtype in de
vervolgkeuzelijst, en selecteer COM-XX voor Poort (Volgens de poort die
door uw computer is toegewezen in de apparaatbeheerder)

C. Zorg ervoor dat u de **ESP32Servo** bibliotheek hebt geüpload en upload
vervolgens de code. De deur van de voerbak zal langzaam openen en sluiten.

![image-20250417085407205](../media/image-20250417085407205.png)

OPMERKING: Als na het uploaden van de code de deur niet kan worden geopend
en gesloten en de servo heet is, schakel dan onmiddellijk de stroom uit.

**controleer:**

1.  Of de plastic deur goed contact maakt en krachtpunten heeft met de
    tandwielstructuur van de servo.
2.  Of de punt van de bevestigingsschroef op de tandwielstructuur van de
...
**Voor de temperatuur- en vochtigheidssensor, verbind geel met S, rood met V,
zwart met G.**
...
**Voor het LCD-scherm, verbind groen met SCL, blauw met SDA, rood met VCC,
zwart met GND.**
...
**Let op de kleur van de Dupont-draad: Voor de ultrasone
module, verbind blauw met TRIG, groen met ECHO, rood met VCC, zwart met GND.**
...
**Let op de kleur van de Dupont-draad: Verbind geel met S,
...
| --- | --- | --- | --- |
| 1 | Ventilator | 4-pins, Verdeeld Zwart-Rood-Blauw-Groen | io18(IN-) \ io19(IN+) |  |
| 2 | PIR Bewegingssensor | 3-pins 15cm | io23 |
| 3 | Knop | 3-pins 15cm | io5 |
| 4 | Ultrasone Module | 4-pins, Verdeeld Zwart-Groen-Blauw-Rood | D12(TRIG) D13(ECHO) |
| 5 | LCD 1602 | 4-pins, Verbonden | I2C |
| 6 | Temperatuur- en Vochtigheidssensor | 3-pins 20cm | io17 |
| 7 | Stoom Sensor | 3-pins 15cm | io35 |
| 8 | Fotoweerstand | 3-pins 15cm | io34 |
| 9 | Servo | -- | io26 |
| 10 | Buzzer | 3-pins 20cm | io16 |
| 11 | LED | 3-pins 20cm | io27 |
| 12 | Waterniveausensor | 3-pins 25cm | io33 |
| 13 | Bodemvochtigheidssensor | 3-pins 20cm | io32 |
| 14 | Waterpomp | 3-pins 20cm | io25 |


#### 11.2 Ventilator


Haal de Dupont-draad die is aangesloten op de ventilator door het gat **gemarkeerd met 30**
op de houten plank.

| Componenten | Draad | ESP32 Board Pins |
| --- | --- | --- |
| Ventilator | 4-PINS Verdeeld (Zwart-Rood-Blauw-Groen) | io18(IN-), io19(IN+) |
...
Haal de Dupont-draad die is aangesloten op de PIR bewegingssensor door het gat
gemarkeerd met 24 op de houten plank.

| Component | Draad | ESP32 Board Pin |
| --- | --- | --- |
| PIR Bewegingssensor | 3-PINS 15cm | io23 |
...
Haal de Dupont-draad die is aangesloten op de knopmodule door het gat
gemarkeerd met 25 op de houten plank.

| Component | Draad | ESP32 Board Pin |
| --- | --- | --- |
| Knop | 3-PINS 15cm | io5 |
...
| --- | --- | --- |
| Ultrasone Module | 4-PINS **Verdeeld** ( Zwart-Groen-Blauw-Rood) | io13(ECHO), io12(TRIG) |
...
| Component | Draad | ESP32 Board Pins |
| --- | --- | --- |
| LCD1602 | 4PIN Aangesloten (Zwart-Rood-Blauw-Groen) | I2C |
...
Haal de Dupont-draad die is aangesloten op de knopmodule door het gat gemarkeerd met 20 op de houten plaat.
...
Haal de draad van de Servo door Gat 15 en sluit deze vervolgens aan op het ESP32
bord.
...
Haal de draad van de Buzzer door Gat 17 en sluit deze vervolgens aan op het
ESP32 bord.
...
**Verbind rood met V, zwart met G, geel met io16.**
...
Haal de draad van de LED door Gat 7 en sluit deze vervolgens aan op het ESP32
bord.
...
**Verbind rood met V, zwart met G, geel met io27.**
...
Haal de draad van de waterniveausensor door Gat 13 en sluit deze vervolgens
aan op het ESP32 bord.

| Component | Draad | ESP32 Board Pin |
| --- | --- | --- |
| Waterniveausensor | 3PIN 25cm | io33 |

**Verbind rood met V, zwart met G, geel met io33.**
...
Haal de draad van de bodemvochtigheidssensor door Gat 11 en sluit deze vervolgens
aan op het ESP32 bord.
...
**Verbind rood met V, zwart met G, geel met io32.**
...
De rode draad van de waterpomp is verbonden met de middelste aansluiting van de relaismodule, en de zwarte draad is verbonden met de GND van het ESP32-bord.

Daarnaast moet u een Dupont-draad gebruiken om de linker aansluiting van de relaismodule te verbinden met de 3.3V van de ESP32.
...
Na de bovenstaande stappen, let op dat alle bedrading is voltooid. En de draden van de LED, waterniveausensor, bodemvochtigheidssensor, zoemer en relaiswaterpomp zijn respectievelijk door de gaten 7, 11, 13, 17 en 40 gesneden in de lindehouten plaat, ter voorbereiding op de daaropvolgende installatie.
...
### Stap 13 Installeer de plastic wasbakken
...
### Stap 14 Installeer de bodemmodule en waterniveaumodule
