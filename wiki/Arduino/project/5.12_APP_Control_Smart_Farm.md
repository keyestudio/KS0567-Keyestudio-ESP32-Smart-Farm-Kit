...
**Let op: Laat geen water overlopen uit plastic bakken tijdens experimenten. Morsen van water op andere sensoren kan kortsluiting of defecte modules veroorzaken. Als batterijen nat worden, kan zelfs een explosie optreden. Wees extra voorzichtig! Voor jongere gebruikers, gelieve samen met uw ouders te werken. Gebruik batterijen voor stroom in plaats van alleen USB.**
...
Verander `your_SSID` in de code naar de naam van uw wifi, en `your_PASSWORD` naar het wifi-wachtwoord. Upload vervolgens de code.
