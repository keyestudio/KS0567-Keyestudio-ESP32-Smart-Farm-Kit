...
**Atención: No desborde agua de las piscinas de plástico en los experimentos. Derramar agua sobre otros sensores puede causar un cortocircuito o que los módulos dejen de funcionar. Si las baterías se mojan, incluso puede ocurrir una explosión. ¡Tenga mucho cuidado! Para usuarios más jóvenes, por favor, opere con sus padres. Use baterías para la alimentación en lugar de solo USB.**
...
Cambie `your_SSID` en el código por el nombre de su wifi, y `your_PASSWORD` por la contraseña de su wifi. Luego suba el código.
