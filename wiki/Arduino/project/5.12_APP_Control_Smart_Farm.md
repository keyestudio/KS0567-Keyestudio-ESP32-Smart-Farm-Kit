### 5.12 Ferme intelligente contrôlée par APP

**Attention : Ne laissez pas l'eau déborder des piscines en plastique pendant les expériences. Des éclaboussures d'eau sur d'autres capteurs peuvent provoquer un court-circuit ou la mise hors service des modules. Si les piles sont mouillées, une explosion peut même se produire. Soyez extrêmement prudent ! Pour les jeunes utilisateurs, veuillez opérer avec vos parents. Utilisez des piles pour l'alimentation au lieu de simplement l'USB.**

Ouvrez le code **5.12.1APP-Smart-Farm** avec Arduino IDE.
