...
- Method 1: Open **window_servo.ino** on **Arduino IDE** and upload it to ESP32 board. 

  ![img](./scratch_img/image028.png)


- Method 2: Open **Scratch 3.0**. Select ESP32 board and the correct serial port, and burn the following code to the board.
...
|             Module              |              Wire               |
| :-----------------------------: | :-----------------------------: |
| Temperature and Humidity Sensor |            3PIN 15cm            |
...
|  6   | Temperature and Humidity Sensor |               3pin 15cm                |            io17            |
...
|            Component            |   Wire    | ESP32 Board Pins |
| :-----------------------------: | :-------: | :--------------: |
| Temperature and Humidity Sensor | 3PIN 15cm |       io17       |
...
![image-20230607175228556](./scratch/image-20230607175228556.png)
...
We adopt Speaker![img](img/st60.png) code blocks to drive the buzzer to vibrate.
...
- Drag a "**Tone**" block from ![img](img/st60.png) as shown below, and set pin to IO16.
...
![image-20230607085516167](./scratch/image-20230607085516167.png)
...
For wifi details, please refer to: https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-reference/network/esp_wifi.html
